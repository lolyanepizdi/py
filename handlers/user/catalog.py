...
async def add_product_callback_handler(query: CallbackQuery, callback_data: dict):
    ...
    db.query('INSERT INTO cart(cid, idx, quantity, payment_status) VALUES (?, ?, 1, "null")', (query.message.chat.id, callback_data['id']))
...
async def show_products(m, products):
    ...
    if len(products) == 0:
        ...
        for idx, title, body, image, price, amount, _ in products:
